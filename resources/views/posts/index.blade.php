    ...
    <section class="cta-section theme-bg-light py-3">
        <div class="container text-center single-col-max-width">
            <div class="single-form-max-width pt-3 mx-auto">
                <form class="signup-form row g-2 g-lg-2 align-items-center" style="justify-content: center">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="date" id="date" class="form-control me-md-1 semail" placeholder="Enter date" style="color:grey">
                    </div>
                    <div class="col-12 col-md-2">
